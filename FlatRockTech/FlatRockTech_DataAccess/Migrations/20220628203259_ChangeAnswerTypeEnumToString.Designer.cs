...
namespace FlatRockTech_DataAccess.Migrations
{
    ...
    [Migration("20220628203259_ChangeAnswerTypeEnumToString")]
    partial class ChangeAnswerTypeEnumToString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlatRockTech_Models.Models.AnswerType", b =>
                {
                    b.Property<int>("AnswerType_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AnswerTypeChoice")
                        .HasColumnType("int");

                    b.HasKey("AnswerType_Id");
            ...
            modelBuilder.Entity("FlatRockTech_Models.Models.Answer", b =>
                {
                    b.HasOne("FlatRockTech_Models.Models.AnswerType", "AnswerType")
                        .WithMany()
                        .HasForeignKey("AnswerType_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
